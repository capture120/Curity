...
insert into disease (diseaseID, name, description, precaution) values (4, 'Peptic ulcer disease', 'Psoriasis is a common skin disorder that forms thick, red, bumpy patches covered with silvery scales', 'MRI of R Ankle using Oth Contrast');
